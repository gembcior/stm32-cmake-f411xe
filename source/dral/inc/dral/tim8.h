...
private:
  ...
  public:
    ...
    using ccpc = FieldModel<address, 0, 0x00000001>;
  };
...
private:
  ...
  public:
    ...
    using comde = FieldModel<address, 13, 0x00000001>;
    ...
    using bie = FieldModel<address, 7, 0x00000001>;
...
private:
  ...
  {
  public:
    using moe = FieldModel<address, 15, 0x00000001>;
